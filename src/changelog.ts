...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    description:
      "Stats has a new group section. Yesterday in the group sums up the whole day: games played, who played most, and the best run. Recent activity shows the last games anyone finished, updating live, and tells you when other people have the game open at the same time as you.",
  },
  {
    version: '1.45.0',
    date: '2026-07-27',
  ...
  },
  {
    ...
    description: 'Perfect day (win a daily challenge outright) and On the board (make a leaderboard) join the ladder, plus three for how your numbers actually land: Neighbours, The Alexander, and Two ends of the scale.',
  },
  {
    version: '1.41.0',
    date: '2026-07-26',
    title: 'One page for all your stats',
    description: "Hi, it's Jacob. I didn't like the old stats look, so I've brought it all into one page. It's easier to see it all now. Happy number picking.",
  },
  {
    version: '1.40.0',
    date: '2026-07-25',
