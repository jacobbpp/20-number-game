...
Leaderboard tracks the top 10 free-play scores by day, week, month, and all time. A score that makes the cut prompts for a name, arcade-style, no sign-in, just remembered on this device for next time. The board is genuinely the top 10 games, not the top 10 players, so one strong run can hold several spots. Tap any entry to see the actual board it was set on. A trophy icon in the header opens it directly, no need to go through Stats first.
